...
const ServicesPage = () => {
  ...
  const practiceAreas = [
    ...
    },
    {
      ...
      description:
        "Comprehensive civil litigation services including property disputes, contract matters, and recovery suits.",
  ...
  const testimonials = [
    {
      ...
      text: "Advocate Mahaveer Aacharya handled my property case with utmost professionalism. His strategic approach won us the case.",
    },
    {
      id: 2,
      name: "Priya Sharma",
